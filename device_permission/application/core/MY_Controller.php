...
class API_Controller extends CI_Controller
{
    ...
    protected GroupPermission_Model $GroupPermissionModel;

    protected DevicePermission_Model $DevicePermissionModel;

    protected UserDevicePermission_Model $UserDevicePermissionModel;
    ...
    public function __construct()
    {
        ...
        $this->load->model('v1/GroupPermission_Model');
        $this->GroupPermissionModel = $this->GroupPermission_Model;

        $this->load->model('v1/DevicePermission_Model');
        $this->DevicePermissionModel = $this->DevicePermission_Model;

        $this->load->model('v1/UserDevicePermission_Model');
